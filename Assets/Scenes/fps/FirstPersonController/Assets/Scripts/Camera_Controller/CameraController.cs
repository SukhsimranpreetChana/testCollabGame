    ...
    public class CameraController : MonoBehaviour
    {
        ...
        #region Variables
            ...
            #region Settings
                ...
                [SerializeField] [MinMaxSlider(-90f,90f)] private Vector2 lookAngleMinMaxY = Vector2.zero;
                [SerializeField] [MinMaxSlider(-90f, 90f)] private Vector2 lookAngleMinMaxX = Vector2.zero;
        #endregion
        ...
        #region Custom Methods
            ...
            void CalculateRotation()
            {
                ...
                m_desiredPitch = Mathf.Clamp(m_desiredPitch,lookAngleMinMaxY.x,lookAngleMinMaxY.y);
                if (!PlayerMovement.enabled)
                {
                    m_desiredYaw = Mathf.Clamp(m_desiredYaw, lookAngleMinMaxX.x, lookAngleMinMaxX.y);
                }
            }
